...
> 8/10 GPA. Doing side quests and *learning* about machine *learning* and AI. As the final project together with my classmate developed a web application (R & Shiny) which allows to scan QR-codes on receipts from stores to get info on person's purchases and classify it to provide analytics on customer behavior.
