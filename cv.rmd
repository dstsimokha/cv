...
work <- data.frame(
    ...
    tools = I(list(
        c("Bash", "Python", "SQL", "Superset", "Looker Studio", "Plotly Dash"),
        c("Bash", "Python", "SQL", "PowerBI"),
        c("Bash", "Python", "SQL", "Facebook Prophet"),
        c("Bash", "Python", "SQL", "Facebook Prophet"),
        c("R", "Shiny"),
        c("R", "Shiny"),
        c("R", "Shiny")
...
19 month of ![py](https://simpleicons.org/icons/python.svg)
